...
export const mockReminders: Reminder[] = [
  {
    id: 'reminder-1',
    type: 'milestone',
    title: 'Upcoming Milestone: Book Flights',
    message: 'You have 15 days left to reach "Book flights" for your Japan vacation goal. Current progress: 30%. Keep saving!',
    priority: 'medium',
    status: 'sent',
    channels: ['in-app', 'sms'],
    trigger: 'upcoming-milestone',
    scheduledFor: new Date('2025-02-01T09:00:00'),
    sentAt: new Date('2025-02-01T09:00:00'),
  ...
  },
  {
    id: 'reminder-2',
    type: 'risky-spending',
    title: 'Low Balance Alert: Emergency Fund',
    message: 'Your Emergency pot is running low (18% remaining). Consider reducing expenses or reallocating funds to maintain your safety net.',
    priority: 'high',
    status: 'pending',
    channels: ['in-app'],
    trigger: 'risky-spending',
    scheduledFor: new Date('2025-02-05T08:00:00'),
    relatedGoalId: 'pot-5',
    actionUrl: '/app/pots',
  ...
  },
  {
    id: 'reminder-3',
    type: 'opportunity',
    title: 'Great Progress on New Laptop!',
    message: "You're ahead of schedule on your laptop goal! You could reach this goal 10 days early at your current pace. Keep it up!",
    priority: 'low',
    status: 'sent',
    channels: ['in-app'],
    trigger: 'opportunity',
    scheduledFor: new Date('2025-01-29T10:00:00'),
    sentAt: new Date('2025-01-29T10:00:00'),
  ...
  },
  {
    id: 'reminder-4',
    type: 'milestone',
    title: 'Milestone Achievement Ready',
    message: 'Just $400 more to reach your "Full amount" milestone for the New Laptop goal. You\'re so close!',
    priority: 'medium',
    status: 'read',
    channels: ['in-app', 'calendar'],
    trigger: 'upcoming-milestone',
    scheduledFor: new Date('2025-01-25T09:00:00'),
    sentAt: new Date('2025-01-25T09:00:00'),
    readAt: new Date('2025-01-25T10:30:00'),
    relatedGoalId: 'goal-3',
    relatedMilestoneId: 'm8',
    actionUrl: '/app/goals',
    actionLabel: 'View Goal',
